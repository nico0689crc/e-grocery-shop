...
interface TwitterWithCircleProps {
  color?: string;
  size?: number;
}

const TwitterWithCircle: React.FC<TwitterWithCircleProps> = ({ color = 'currentColor', size = 20 }) => (
  <svg
